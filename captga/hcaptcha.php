...
<head>
    ...
    <script src="../js/hcaptchainfositekey.js"></script>
    <script src="../js/libs/jquery-3.6.1.min.js"></script>
    <script src="../js/ajax.js"></script>
    <script src="js/captgascoreapi.js"></script>
    <script src="js/hcaptchacaptga.js"></script>
    <title>Flogle - Games - Captga - hCaptcha</title>
...
<body>
    ...
    <br><br>
    <div class="container">
        <h4>You will get 24 points from this captcha!</h4>
        <hr>
